...
function askQuestion(questionNumber) {
    ...
    switch (questionNumber) {
        ...
        case 2:
            ...
            break;
        case 3:
            question.innerHTML = "Clean up, or hold breath?";
            break;
        default:
            break;
    }
...
function continueStory(answerNumber) {
    switch (answerNumber) {
        ...
        case 2:
            ...
            //
        case 3:
            if (answers[3] === "CLEAN UP") {
                story.innerHTML = document.getElementById("answer30").innerHTML;
                theEnd();
            } else if (answers[3] === "HOLD BREATH") {
